#NYOMAN ADI ARYA SUBAKTI / 2415091013

#Hello everyone. This is me and today we are here to take a look at a case study using simple linear regression.
#As it is a simple linear regression, use one independent variable and one dependent variable.
#And the equation for this is Y=Bo + B1x + e.
#Use the independent variable to predict the dependent variable.
...
#Here the dataset that have taken gives us the hemoglobin and hematocrit levels of male athletes.
#The goal is to make a simple regression model  to predict hematocrit levels from hemoglobin levels. 
